...
const int64_t __source_i_neurongroup_subgroup_3__offset = 4000;
const size_t _num__source_i_neurongroup_subgroup_3__source_i = 5000;
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t __source_i_neurongroup_subgroup_3__source_i = _ptr_array_neurongroup_i[_idx];
                const int32_t _source_i = __source_i_neurongroup_subgroup_3__source_i - __source_i_neurongroup_subgroup_3__offset;
