#include "code_objects/synapses_13_summed_variable_I_syn_ie_post_codeobject.h"
#include "objects.h"
...
void _run_synapses_13_summed_variable_I_syn_ie_post_codeobject()
{
...
const size_t _numI_syn_ie_post = 500;
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_13__synaptic_post.size();
    ...
    for(int _idx=0; _idx<_ptr_array_synapses_13_N[0]; _idx++)
    {
        ...
        _ptr_array_neurongroup_3_I_syn_ie[_ptr_array_synapses_13__synaptic_post[_idx]] += _synaptic_var;
    }
