...
void _run_synapses_12_pre_push_spikes()
{
    ...
    ///// CONSTANTS ///////////
    const int64_t _n_sources = 4000;
const int64_t _n_targets = 4000;
...
const size_t _numdelay = _dynamic_array_synapses_12_delay.size();
    ...
    double*   _ptr_array_synapses_12_delay = _array_synapses_12_delay;
    ...
    
    {
        ...
        synapses_12_pre.push(_ptr_array_neurongroup_3__spikespace, _ptr_array_neurongroup_3__spikespace[_num_spikespace-1]);
    }
