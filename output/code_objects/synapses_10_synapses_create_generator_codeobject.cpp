...
const int64_t N_pre = 1000;
const int64_t _source_offset = 4000;
...
const int64_t _target_offset = 0;
    ...
    _dynamic_array_synapses_10_A_SE.resize(newsize);
    _dynamic_array_synapses_10_tau_inact.resize(newsize);
    _dynamic_array_synapses_10_y.resize(newsize);
