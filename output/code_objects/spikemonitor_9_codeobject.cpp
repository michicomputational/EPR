...
const int64_t __source_i_neurongroup_4_subgroup_1__offset = 40;
const size_t _num__source_i_neurongroup_4_subgroup_1__source_i = 50;
const size_t _num_clock_t = 1;
const int64_t _source_start = 40;
const int64_t _source_stop = 50;
const size_t _num_source_t = 1;
const size_t _num_spikespace = 51;
const size_t _numcount = 10;
...
const size_t _num_source_idx = 10;
    ///// POINTERS ////////////
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t __source_i_neurongroup_4_subgroup_1__source_i = _ptr_array_neurongroup_4_i[_idx];
                const int32_t _source_i = __source_i_neurongroup_4_subgroup_1__source_i - __source_i_neurongroup_4_subgroup_1__offset;
