...
void _run_synapses_11_pre_push_spikes()
{
    ...
    ///// CONSTANTS ///////////
    const int64_t _n_sources = 1000;
const int64_t _n_targets = 1000;
...
const size_t _numdelay = _dynamic_array_synapses_11_delay.size();
    ...
    double*   _ptr_array_synapses_11_delay = _array_synapses_11_delay;
    ...
    
    {
        ...
        synapses_11_pre.push(_ptr_array_neurongroup_2__spikespace, _ptr_array_neurongroup_2__spikespace[_num_spikespace-1]);
    }
