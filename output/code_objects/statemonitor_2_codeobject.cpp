...
const size_t _num_sub_idx = 40;
    ...
    double*   _ptr_array_statemonitor_2_clock_1_t = _array_statemonitor_2_clock_1_t;
    ...
    int32_t* __restrict  _ptr_array_neurongroup_2_subgroup_3__sub_idx = _array_neurongroup_2_subgroup_3__sub_idx;


    _dynamic_array_statemonitor_2_t.push_back(_ptr_array_statemonitor_2_clock_1_t[0]);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const int32_t _sub_idx = _ptr_array_neurongroup_2_subgroup_3__sub_idx[_idx];
        const double _source_v = _ptr_array_neurongroup_2_v[_sub_idx];
