...
const size_t _numv = 5000;
    ...
    double* __restrict  _ptr_array_neurongroup_1_R = _array_neurongroup_1_R;
    ...
    double* __restrict  _ptr_array_neurongroup_1_tau_mem = _array_neurongroup_1_tau_mem;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double I_syn_ee = _ptr_array_neurongroup_1_I_syn_ee[_idx];
        const double I_syn_ei = _ptr_array_neurongroup_1_I_syn_ei[_idx];
        const double I_syn_ie = _ptr_array_neurongroup_1_I_syn_ie[_idx];
        const double I_syn_ii = _ptr_array_neurongroup_1_I_syn_ii[_idx];
        const double R = _ptr_array_neurongroup_1_R[_idx];
        ...
        const double tau_mem = _ptr_array_neurongroup_1_tau_mem[_idx];
