...
void _run_synapses_pre_codeobject_1()
{
    ...
    ///// CONSTANTS ///////////
    double* const _array_synapses_U_SE = _dynamic_array_synapses_U_SE.empty()? 0 : &_dynamic_array_synapses_U_SE[0];
const size_t _numU_SE = _dynamic_array_synapses_U_SE.size();
...
double* const _array_synapses_x = _dynamic_array_synapses_x.empty()? 0 : &_dynamic_array_synapses_x[0];
const size_t _numx = _dynamic_array_synapses_x.size();
...
const size_t _numy = _dynamic_array_synapses_y.size();
    ...
    double* __restrict  _ptr_array_synapses_U_SE = _array_synapses_U_SE;
    int32_t* __restrict  _ptr_array_synapses__synaptic_pre = _array_synapses__synaptic_pre;
    double* __restrict  _ptr_array_synapses_x = _array_synapses_x;
        ...
        _spiking_synapse_idx++)
    {
        ...
        const double U_SE = _ptr_array_synapses_U_SE[_idx];
        double x = _ptr_array_synapses_x[_idx];
        double y = _ptr_array_synapses_y[_idx];
        y += U_SE * x; // important: update y first
        x += (- U_SE) * x;
        _ptr_array_synapses_x[_idx] = x;
        _ptr_array_synapses_y[_idx] = y;
