...
const size_t _numdelay = _dynamic_array_synapses_9_delay.size();
    ...
    double*   _ptr_array_synapses_9_delay = _array_synapses_9_delay;
    ...
    
    {
        ...
        synapses_9_pre.push(_ptr_array_neurongroup_2__spikespace, _ptr_array_neurongroup_2__spikespace[_num_spikespace-1]);
    }
