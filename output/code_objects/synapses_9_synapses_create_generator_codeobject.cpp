...
const int64_t _target_offset = 4000;
    ///// POINTERS ////////////
    ...
    _dynamic_array_synapses_9_A_SE.resize(newsize);
    _dynamic_array_synapses_9_tau_inact.resize(newsize);
    _dynamic_array_synapses_9_y.resize(newsize);
