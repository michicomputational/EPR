#include "code_objects/synapses_12_summed_variable_I_syn_ei_post_codeobject.h"
#include "objects.h"
...
void _run_synapses_12_summed_variable_I_syn_ei_post_codeobject()
{
...
const size_t _numI_syn_ei_post = 500;
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_12__synaptic_post.size();
    ...
    {
        _ptr_array_neurongroup_3_I_syn_ei[_target_idx + 400] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_synapses_12_N[0]; _idx++)
    {
        ...
        _ptr_array_neurongroup_3_I_syn_ei[_ptr_array_synapses_12__synaptic_post[_idx]] += _synaptic_var;
    }
