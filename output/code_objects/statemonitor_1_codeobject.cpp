...
const size_t _num_indices = 25;
const size_t _num_source_v = 10000;
...
const size_t _num_sub_idx = 25;
    ///// POINTERS ////////////
        
    int32_t*   _ptr_array_statemonitor_1_N = _array_statemonitor_1_N;
    double*   _ptr_array_statemonitor_1_clock_1_t = _array_statemonitor_1_clock_1_t;
    ...
    int32_t* __restrict  _ptr_array_neurongroup_1_subgroup_5__sub_idx = _array_neurongroup_1_subgroup_5__sub_idx;


    _dynamic_array_statemonitor_1_t.push_back(_ptr_array_statemonitor_1_clock_1_t[0]);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const int32_t _sub_idx = _ptr_array_neurongroup_1_subgroup_5__sub_idx[_idx];
        const double _source_v = _ptr_array_neurongroup_1_v[_sub_idx];
