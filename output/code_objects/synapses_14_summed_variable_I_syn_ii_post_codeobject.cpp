#include "code_objects/synapses_14_summed_variable_I_syn_ii_post_codeobject.h"
#include "objects.h"
...
void _run_synapses_14_summed_variable_I_syn_ii_post_codeobject()
{
...
const size_t _numI_syn_ii_post = 500;
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_14__synaptic_post.size();
    ...
    {
        _ptr_array_neurongroup_3_I_syn_ii[_target_idx + 400] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_synapses_14_N[0]; _idx++)
    {
        ...
        _ptr_array_neurongroup_3_I_syn_ii[_ptr_array_synapses_14__synaptic_post[_idx]] += _synaptic_var;
    }
