#include "code_objects/synapses_13_summed_variable_I_syn_ei_post_codeobject.h"
#include "objects.h"
...
void _run_synapses_13_summed_variable_I_syn_ei_post_codeobject()
{
    using namespace brian;


    ///// CONSTANTS ///////////
    double* const _array_synapses_13_A_SE = _dynamic_array_synapses_13_A_SE.empty()? 0 : &_dynamic_array_synapses_13_A_SE[0];
const size_t _numA_SE = _dynamic_array_synapses_13_A_SE.size();
const size_t _numI_syn_ei_post = 5000;
const size_t _numN = 1;
const int64_t N_post = 1000;
...
double* const _array_synapses_13_y = _dynamic_array_synapses_13_y.empty()? 0 : &_dynamic_array_synapses_13_y[0];
const size_t _numy = _dynamic_array_synapses_13_y.size();
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_13__synaptic_post.size();
    ///// POINTERS ////////////
        
    double* __restrict  _ptr_array_synapses_13_A_SE = _array_synapses_13_A_SE;
    double* __restrict  _ptr_array_neurongroup_3_I_syn_ei = _array_neurongroup_3_I_syn_ei;
    ...
    double* __restrict  _ptr_array_synapses_13_y = _array_synapses_13_y;
    ...
    {
        _ptr_array_neurongroup_3_I_syn_ei[_target_idx + 4000] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_synapses_13_N[0]; _idx++)
    {
        // vector code
        const size_t _vectorisation_idx = _idx;
                
        const double A_SE = _ptr_array_synapses_13_A_SE[_idx];
        const double y = _ptr_array_synapses_13_y[_idx];
        const double _synaptic_var = A_SE * y;

        _ptr_array_neurongroup_3_I_syn_ei[_ptr_array_synapses_13__synaptic_post[_idx]] += _synaptic_var;
    }
