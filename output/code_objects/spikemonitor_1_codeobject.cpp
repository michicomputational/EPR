...
const int64_t __source_i_neurongroup_1_subgroup_4__offset = 5000;
const size_t _num__source_i_neurongroup_1_subgroup_4__source_i = 10000;
const size_t _num_clock_t = 1;
const int64_t _source_start = 5000;
const int64_t _source_stop = 5025;
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t __source_i_neurongroup_1_subgroup_4__source_i = _ptr_array_neurongroup_1_i[_idx];
                const int32_t _source_i = __source_i_neurongroup_1_subgroup_4__source_i - __source_i_neurongroup_1_subgroup_4__offset;
