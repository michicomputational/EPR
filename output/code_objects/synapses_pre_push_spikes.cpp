...
void _run_synapses_pre_push_spikes()
{
    ...
    ///// CONSTANTS ///////////
    const int64_t _n_sources = 5000;
const int64_t _n_targets = 10000;
...
const size_t _numdelay = _dynamic_array_synapses_delay.size();
    ...
    double*   _ptr_array_synapses_delay = _array_synapses_delay;
    ...
    
    {
        ...
        synapses_pre.push(_ptr_array_neurongroup_1__spikespace, _ptr_array_neurongroup_1__spikespace[_num_spikespace-1]);
    }
