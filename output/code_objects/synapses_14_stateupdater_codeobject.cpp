#include "code_objects/synapses_14_stateupdater_codeobject.h"
#include "objects.h"
...
double* const _array_synapses_14_tau_inact = _dynamic_array_synapses_14_tau_inact.empty()? 0 : &_dynamic_array_synapses_14_tau_inact[0];
const size_t _numtau_inact = _dynamic_array_synapses_14_tau_inact.size();
...
const size_t _numy = _dynamic_array_synapses_14_y.size();
    ...
    double* __restrict  _ptr_array_synapses_14_tau_inact = _array_synapses_14_tau_inact;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        const double tau_inact = _ptr_array_synapses_14_tau_inact[_idx];
        double y = _ptr_array_synapses_14_y[_idx];
        const double _y = y * exp(1.0f*_lio_1/tau_inact);
        y = _y;
        _ptr_array_synapses_14_y[_idx] = y;
