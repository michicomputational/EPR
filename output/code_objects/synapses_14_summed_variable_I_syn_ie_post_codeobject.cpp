#include "code_objects/synapses_14_summed_variable_I_syn_ie_post_codeobject.h"
#include "objects.h"
...
void _run_synapses_14_summed_variable_I_syn_ie_post_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    double* const _array_synapses_14_A_SE = _dynamic_array_synapses_14_A_SE.empty()? 0 : &_dynamic_array_synapses_14_A_SE[0];
const size_t _numA_SE = _dynamic_array_synapses_14_A_SE.size();
const size_t _numI_syn_ie_post = 5000;
...
double* const _array_synapses_14_y = _dynamic_array_synapses_14_y.empty()? 0 : &_dynamic_array_synapses_14_y[0];
const size_t _numy = _dynamic_array_synapses_14_y.size();
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_14__synaptic_post.size();
    ///// POINTERS ////////////
        
    double* __restrict  _ptr_array_synapses_14_A_SE = _array_synapses_14_A_SE;
    double* __restrict  _ptr_array_neurongroup_3_I_syn_ie = _array_neurongroup_3_I_syn_ie;
    ...
    double* __restrict  _ptr_array_synapses_14_y = _array_synapses_14_y;
    ...
    {
        _ptr_array_neurongroup_3_I_syn_ie[_target_idx + 0] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_synapses_14_N[0]; _idx++)
    {
        // vector code
        const size_t _vectorisation_idx = _idx;
                
        const double A_SE = _ptr_array_synapses_14_A_SE[_idx];
        const double y = _ptr_array_synapses_14_y[_idx];
        const double _synaptic_var = A_SE * y;

        _ptr_array_neurongroup_3_I_syn_ie[_ptr_array_synapses_14__synaptic_post[_idx]] += _synaptic_var;
    }
