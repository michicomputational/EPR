...
const int _num__array_spikemonitor__source_idx = 5000;
int32_t * _array_spikemonitor_count;
const int _num__array_spikemonitor_count = 5000;
...
void _init_arrays()
{
    ...
    _array_spikemonitor__source_idx = new int32_t[5000];
    
    for(int i=0; i<5000; i++) _array_spikemonitor__source_idx[i] = 0;

    _array_spikemonitor_count = new int32_t[5000];
    
    for(int i=0; i<5000; i++) _array_spikemonitor_count[i] = 0;
    ...
    for(int i=0; i<5000; i++) _array_spikemonitor__source_idx[i] = 0 + i;
...
void _write_arrays()
{
    ...
    {
        outfile__array_spikemonitor__source_idx.write(reinterpret_cast<char*>(_array_spikemonitor__source_idx), 5000*sizeof(_array_spikemonitor__source_idx[0]));
    ...
    {
        outfile__array_spikemonitor_count.write(reinterpret_cast<char*>(_array_spikemonitor_count), 5000*sizeof(_array_spikemonitor_count[0]));
